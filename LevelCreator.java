...
public abstract class LevelCreator {
    public static  ArrayList<Planet> generateLevel(int level){
        ...
        if(level == 0) {
            planets.add(new Planet(156, 174, 100, 6, ResourceLoader.loadImage("planets/orangeplanet.png")));
            planets.add(new Planet(575, 406, 50, 20, ResourceLoader.loadImage("planets/testpurpleplanet.png")));
            planets.add(new Planet(625, 163, 75, 10, ResourceLoader.loadImage("planets/greenplanet.png")));
            planets.add(new Planet(300, 400, 50, 14, ResourceLoader.loadImage("planets/redplanet.png")));
        }else if(level == 1){
